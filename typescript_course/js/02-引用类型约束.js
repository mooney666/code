...
let names = ["小红", "小明"];
let sexes = [true, true, true];
console.log(ages, names, sexes);
let ages1 = [22, 33, 44, 55];
let names1 = ["小红", "小明"];
let sexes1 = [true, true, true];
console.log(ages1, names1, sexes1);
// (number | string | boolean)[]: 联合类型，数组中的元素，只能是三个类型中的其中一种。
let data = [10, "11", true];
let data1 = [20, "13", false];
let data2 = [30, "14", true];
let data3 = [40, "15", false];
let testData = 20;
testData = "小明";
testData = true;
testData = [1, 2, 3, 4];
